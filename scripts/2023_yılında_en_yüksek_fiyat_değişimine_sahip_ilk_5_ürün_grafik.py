...
with open('queries/2023 yılında en yüksek fiyat değişimine sahip ilk 5 ürün.sql', 'r') as file:
    sql_query = file.read()
...
plt.title('2023 Yılında En Yüksek Fiyat Değişimine Sahip İlk 5 Ürün', fontsize=16)
...
plt.savefig('outputs/2023 yılında en yüksek fiyat değişimine sahip ilk 5 ürün.png')
