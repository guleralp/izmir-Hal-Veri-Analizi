...
with open("queries/2022 yılı içindeki en düşük fiyata sahip ürün ve fiyat değişimi.sql", 'r') as file:
    sql_query = file.read()
...
# Başlık ve etiketler
plt.title('2022 Yılı İçindeki En Düşük Fiyata Sahip Ürün Ve Fiyat Değişim Analizi', fontsize=12)
...
plt.savefig('outputs/2022_yili_en_dusuk_fiyatli_urun_ve_fiyat_degisimi.png',dpi=300)
