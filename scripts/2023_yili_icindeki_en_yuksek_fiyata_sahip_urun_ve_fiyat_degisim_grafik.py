...
with open("queries/2023 yılı içindeki en yüksek fiyata sahip ürün ve fiyat değişimi.sql", 'r') as file:
    sql_query = file.read()
...
# En yüksek fiyata sahip ürün adı
...
# Başlık ve etiketler
plt.title('2023 Yılı İçindeki En Yüksek Fiyata Sahip Ürün Ve Fiyat Değişim Analizi', fontsize=12)
...
plt.legend(title=f'Product_name: {product_name}', loc='upper left', fontsize=8, frameon=True)

# Grafik çıktısını outputs klasörüne kaydetme
plt.savefig('outputs/2023 Yılı İçindeki En Yüksek Fiyata Sahip Ürün Ve Fiyat Değişimi.png')
