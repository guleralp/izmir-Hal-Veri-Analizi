...
with open("queries/2024 yılı içindeki en yüksek fiyata sahip ürün ve fiyat değişimi.sql", 'r') as file:
    sql_query = file.read()
...
# Başlık ve etiketler
plt.title('2024 Yılı İçindeki En Yüksek Fiyata Sahip Ürün Ve Fiyat Değişim Analizi', fontsize=12)
...
plt.savefig('outputs/2024 Yılı İçindeki En Yüksek Fiyata Sahip Ürün Ve Fiyat Değişimi.png')
