...
# Grafik Özellikleri
plt.title("2024 Yılı Sonbahar Mevsimi İçin Fiyat Değişimi En Yüksek 5 Ürün", fontsize=14)
...
plt.savefig('outputs/2024_sonbahar_en_yuksek_fiyat_degisimi_top5.png')
# Grafiği Göster
plt.show()
