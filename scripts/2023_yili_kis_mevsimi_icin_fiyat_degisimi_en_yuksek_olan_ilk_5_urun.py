...
with open('queries/2023 Yılı  Kış Mevsimi için fiyat değişimi en yüksek olan ilk 5 ürün.sql', 'r') as file:
    sql_query = file.read()
df = pd.read_sql(sql_query, connection)
connection.close()
# Seaborn renk paleti ile çubukların rengini düzenleme
custom_colors = ['#680000', '#f70202', '#b4c88a', '#ebece7', '#04d415']  
...
# Grafik Özellikleri
plt.title("2023 Yılı Kış Mevsimi için fiyat değişimi en yüksek olan ilk 5 ürün", fontsize=14)
