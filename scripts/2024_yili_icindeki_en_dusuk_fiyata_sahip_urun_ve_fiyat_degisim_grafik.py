...
with open("queries/2024 yılı içindeki en düşük fiyata sahip ürün ve fiyat değişimi.sql", 'r') as file:
    sql_query = file.read()
...
plt.savefig('outputs/2024_yili_en_dusuk_fiyatli_urun_ve_fiyat_degisimi.png')
