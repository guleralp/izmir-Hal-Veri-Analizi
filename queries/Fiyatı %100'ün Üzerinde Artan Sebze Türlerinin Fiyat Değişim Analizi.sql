WITH price_changes AS (
    ...
    FROM worksheet
    WHERE type = 'SEBZE' -- Sadece sebze ürünleri için filtre
)
...
WHERE next_price IS NOT NULL
  AND DATEDIFF(next_date, DATE) < 10  -- 10 günden az fark
  AND ((next_price - current_price) / current_price) * 100 > 100 -- %100'den fazla artış
